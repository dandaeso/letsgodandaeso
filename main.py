...
if True:
    ...
    dagger_sound = get_sound('assets/weapon_sound/dagger.MP3')
    fireball_sound = get_sound('assets/weapon_sound/fireball.MP3')
    explosion_sound = get_sound('assets/weapon_sound/explosion.MP3')
    sword_sound = get_sound('assets/weapon_sound/sword.MP3')
    star_sound = get_sound('assets/weapon_sound/star.MP3')

    plant_sound=get_sound('assets/enemy_sound/plant.MP3')
    ghost_sound=get_sound('assets/enemy_sound/ghost.MP3')
    goblin_sound=get_sound('assets/enemy_sound/goblin.MP3')
    pharaoh_sound=get_sound('assets/enemy_sound/pharaoh.MP3')
    bubble_sound=get_sound('assets/enemy_sound/bubble.MP3')
    skeleton_sound=get_sound('assets/enemy_sound/skeleton.MP3')
    jellyfish_sound=get_sound('assets/enemy_sound/squid.MP3')
    turtle_sound=get_sound('assets/enemy_sound/turtle.MP3')
    zombie_sound=get_sound('assets/enemy_sound/zombie.MP3')

    victory_sound=get_sound('assets/sound/victory.MP3')
    levelup_sound=get_sound('assets/sound/levelup.MP3')
    gameover_sound=get_sound('assets/sound/gameover.MP3')
    button_sound=get_sound('assets/sound/button.MP3')
    walk_sound=get_sound('assets/sound/walk.MP3')
    stamp_sound=get_sound('assets/sound/stamp.MP3')

    map_type=0
    music=[get_sound(f"assets/music/music{i}.MP3") for i in range(1,5)]
    music_playing=play_bg_music(map_type,music)
        ...
        try:
            ...
            if len(enemy_l)<enemy_mount:
                ...
                if enemy_type == 'zombie':
                    ...
                    play_sound(zombie_sound)
                elif enemy_type == 'skeleton':
                    enemy_l.append(enemy.Skeleton())
                    play_sound(skeleton_sound)
